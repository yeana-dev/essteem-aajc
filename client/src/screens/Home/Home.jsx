  ...
  return (
    <main>
      ...
      <div className="home max-w-6xl mx-auto px-4">
        ...
        <section className="flex gap-3 my-5 flex-col sm:flex-row">
        ...
        <div className="flex p-10 lg:justify-between coverStory">
          ...
          <div className="lg:w-1/3 text-white flex flex-col gap-3">
            <header>
              ...
              <h5 className="my-2">September 29, 2021</h5>
            ...
            <section>
              <p className="text-sm">
                ...
                back to Asia and other negative comments about Asians. She
                yanked the windshield wiper of the car until it broke and
                damaged the car. The elder waited until she moved back to drive
                away and avoid further damage to the car. He was not sure how to
                deal with the situation with his limited English speaking
                skills.
              </p>
              <a
